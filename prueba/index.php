...
<body>
    <header class="header">
        <div class="menu">
            ...
            <div class="nav">
                <div class="div barra">
                    <a href="login.html"><i class="fa-regular fa-circle-user"></i>Iniciar Sesion</a>
                </div>
                <div class="div barra">
                    <a href=""><i class="fa-solid fa-bag-shopping"></i>Productos</a>
                </div>
                <div class="div">
                    <a href=""><i class="fa-solid fa-scissors"></i>Servicios</a>
                </div>
            </div>
        </div>
    ...
    <section class="mosaico">
        <div class="row">
            ...
            <div class="column">
                <img src="imagenes/mosaico4copia.jpg">
                <img src="imagenes/mosaico5copia.jpg">
                <img src="imagenes/mosaico6copia.jpg">
            </div>
            <div class="column">
                <img src="imagenes/mosaico7copia.jpg">
                <img src="imagenes/mosaico8copia.jpg">
                <img src="imagenes/mosaico9copia.jpg">
    ...
    <section class="contactos">
        ...
        <div class="derecha">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d997.2368477313419!2d-77.28100856557357!3d1.197182750317089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2sco!4v1675954202134!5m2!1ses-419!2sco" 
